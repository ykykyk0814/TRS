...
class PreferenceRequestDTO(BaseModel):
    ...
    prefers_email: bool = Field(
        True, description="Whether user prefers email notifications"
    )
    prefers_sms: bool = Field(
...
class PreferenceUpdateDTO(BaseModel):
    ...
    prefers_sms: Optional[bool] = Field(
...
class PreferenceResponseDTO(BaseModel):
    ...
    user_id: UUID = Field(..., description="ID of the user")
    prefers_email: bool = Field(
        ..., description="Whether user prefers email notifications"
    )
